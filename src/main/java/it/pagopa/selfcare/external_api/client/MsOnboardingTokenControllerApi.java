...
@FeignClient(name = "${rest-client.ms-onboarding-token-api.serviceCode}", url = "${rest-client.ms-onboarding.base-url}", configuration = MsOnboardingApiClientConfig.class)
