...
@Aspect
@Component
public class ExternalApiControllerResponseValidator extends ControllerResponseValidator {//TODO change Name
    ...
    @Override
    @Pointcut("execution(* it.pagopa.selfcare.external_api.web.controller.*.*(..))")
